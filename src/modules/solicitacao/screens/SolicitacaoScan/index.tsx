...
import {
  ...
  setScanLayout,
  setScanVisible,
} from '../../reducers/solicitacaoScan/solicitacaoScanReducer';
...
const SolicitacaoScan: React.FC<
  StackScreenProps<SolicitacaoRoutesParams, 'solicitacaoScan'>
> = ({navigation}) => {
  ...
  const {
    ...
    scanLayout,
    scanVisible,
  } = useAppSelector(s => s.solicitacaoScan);
    ...
    <>
      <Render
        ...
        <RNCamera
          ...
          flashMode={
            RNCamera.Constants.FlashMode[scanFlashlight ? 'torch' : 'off']
          }
          captureAudio={false}
          ...
          <BarcodeMask
            ...
            onLayoutMeasured={({nativeEvent: {layout}}) =>
              dispatch(setScanLayout(layout))
            }
          />
        </RNCamera>
