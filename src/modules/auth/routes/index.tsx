...
import AuthTypeOperation from '../screens/AuthTypeOperation/AuthTypeOperation';
...
const AuthRoutes: React.FC = () => {
  ...
  const {isCancelOperation} = useAppSelector(s => s.auth);
  ...
  return (
    <Stack.Navigator
      initialRouteName={
        gpsEnabled && locationEnabled === true
          ? 'authCode'
      ...
      <Stack.Screen name="authTypeOperation" component={AuthTypeOperation} />
    </Stack.Navigator>
  );
};
